...
namespace AspCoreLibraryEF.Models
{
    ...
    public class BookMockData : IBookRepository
    {
        ...
        public IEnumerable<Book> Books =>
            ...
            new Book { ID = 2, Title = "Sun Set", Discription = "When the sun set", Price = 500, ImageUrl = "", PublishDate = new DateTime(1984, 03, 01), InStock = true, CategoryId = 3, Category= _ICategory.Categories.ToList()[3] }
        };
